            ...
            <div class="content">
                ...
                <div class="content-profile">
                    <div class="card">
                        ...
                        <div class="info" style="padding: 2rem;">
							<div class="label" style="margin-bottom: 2rem;">
                            ...
                            <div class="label-row">
								...
								<div class="label">
									<div class="desc">Dostępny w dniach:<br /><br />
									<?php
									...
									<div class="desc"><a style="text-decoration:underline" href="reviews.php?id=<?=$_GET['id']?>">Zobacz opinie o tym masażyście</a>
									</div>							
									<br /><br />
								</div>	
								
							</div>	
<button class="button" style="margin: 1rem 0; border:none; color: #fff;"><a style="color:#fff" href="reservation-add.php?id=<?=$_GET['id']?>">Umów wizytę</a></button>	
                        </div>
                    </div>
                </div>
            </div>
